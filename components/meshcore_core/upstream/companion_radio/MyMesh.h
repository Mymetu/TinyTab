...
public:
  ...
  bool advert();
  // Public wrapper used by the platform port for an application-triggered
  // flood advertisement. The scoped routing details remain internal.
  void sendFloodAdvert(mesh::Packet* pkt);
  void enterCLIRescue();
